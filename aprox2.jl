...
extractFeatures("./datasets/ojos/", 1, "./datasets/aprox2/patrones.data")
extractFeatures("./datasets/no_ojos/", 0, "./datasets/aprox2/patrones.data")

dataset = readdlm("./datasets/aprox2/patrones.data", ',')
