...
extractFeatures("./datasets/ojos/", 1, "./datasets/aprox1/patrones.data")
extractFeatures("./datasets/no_ojos/", 0, "./datasets/aprox1/patrones.data")

dataset = readdlm("./datasets/aprox1/patrones.data", ',')
