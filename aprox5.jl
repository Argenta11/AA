...
extractFeatures("./datasets/mascarilla/", 1, "./datasets/aprox5/patrones.data")
extractFeatures("./datasets/no_mascarilla/", 0, "./datasets/aprox5/patrones.data")

dataset = readdlm("./datasets/aprox5/patrones.data", ',')
