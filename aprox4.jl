...
extractFeatures("./datasets/mascarilla/", 1, "./datasets/aprox4/patrones.data")
extractFeatures("./datasets/no_mascarilla/", 0, "./datasets/aprox4/patrones.data")

dataset = readdlm("./datasets/aprox4/patrones.data", ',')
